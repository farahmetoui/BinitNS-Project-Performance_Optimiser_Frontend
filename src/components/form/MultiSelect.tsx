...
const MultiSelect: React.FC<MultiSelectProps> = ({
  ...
  const handleSelect = (optionValue: string) => {
    let newSelectedOptions = selectedOptions.includes(optionValue)
      ? selectedOptions.filter((value) => value !== optionValue)
      : [...selectedOptions, optionValue];
    if (optionValue !== "All" && selectedOptions.includes("All")) {
      newSelectedOptions = newSelectedOptions.filter((val) => val !== "All");
    }
